...
public final class DeleteUniversity_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(session.getAttribute("admin")!=null)
  ...
  private boolean _jspx_meth_h_form_0(PageContext _jspx_page_context)
    ...
    _jspx_th_h_form_0.setAction("/deluniv");
    int _jspx_eval_h_form_0 = _jspx_th_h_form_0.doStartTag();
    if (_jspx_eval_h_form_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\n");
        out.write("            Company ID :<input type=\"text\" name=\"univid\" size=\"20\" required /><br><br>\n");
